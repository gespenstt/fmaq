					          ...
					          <tr>
					            ...
					            <td class="col-md-2">
                                                        <form action="<?php echo url_for("maquinaria/eliminar");?>" method="post">
                                                            ...
                                                            <a href="<?php echo url_for("maquinaria/editar/?maq_id=".$p->getMaqId()) ?>"><i class="icon-edit"></i> Editar</a>
					...
					<div align="right">
                                    ...
                                    <ul class="pagination">
                                        ...
                                        if($linkSaltoPrimero >= 1):
                                            echo '<li><a href="'.url_for("maquinaria/index/?p=1").'">«</a></li>';
                                        endif;
                                        ...
                                        foreach ($links as $e): 
                                            ...
                                            echo '<li class="'.$current.'"><a href="'.url_for("maquinaria/index/?p=$e").'">'.$e.'</a></li>';
                                            endif;
                                        endforeach; 
                                        
                                        if($linkSaltoUltimo <= $ultimaPagina):                                            
                                            echo '<li><a href="'.url_for("maquinaria/index/?p=$ultimaPagina").'">»</a></li>';
                                        endif;
