                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="col-md-5"><?php echo $p->getCurNombre(); ?></td>
                            <td class="col-md-4"><?php echo $p->getCurTelefono(); ?></td>
                            <td class="col-md-2">                                
                ...
                <div align="right">
                    ...
                    <ul class="pagination">
                        ...
                        if($linkSaltoPrimero >= 1):
                            echo '<li><a href="'.url_for("cv/index/?p=1").'">«</a></li>';
                        endif;
                        ...
                        foreach ($links as $e): 
                            ...
                            echo '<li class="'.$current.'"><a href="'.url_for("cv/index/?p=$e").'">'.$e.'</a></li>';
                            endif;
                        endforeach; 

                        if($linkSaltoUltimo <= $ultimaPagina):                                            
                            echo '<li><a href="'.url_for("cv/index/?p=$ultimaPagina").'">»</a></li>';
                        endif;
