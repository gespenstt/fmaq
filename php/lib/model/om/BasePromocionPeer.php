...
abstract class BasePromocionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PromId', 'PromTitulo', 'PromDescripcion', 'PromUrlvideo', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('promId', 'promTitulo', 'promDescripcion', 'promUrlvideo', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::PROM_ID, self::PROM_TITULO, self::PROM_DESCRIPCION, self::PROM_URLVIDEO, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('prom_id', 'prom_titulo', 'prom_descripcion', 'prom_urlvideo', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PromId' => 0, 'PromTitulo' => 1, 'PromDescripcion' => 2, 'PromUrlvideo' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('promId' => 0, 'promTitulo' => 1, 'promDescripcion' => 2, 'promUrlvideo' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::PROM_ID => 0, self::PROM_TITULO => 1, self::PROM_DESCRIPCION => 2, self::PROM_URLVIDEO => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('prom_id' => 0, 'prom_titulo' => 1, 'prom_descripcion' => 2, 'prom_urlvideo' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
