...
abstract class BaseUsuarioPeer {
	...
	const USU_APELLIDO = 'usuario.USU_APELLIDO';

	/** the column name for the USU_CORREO field */
	const USU_CORREO = 'usuario.USU_CORREO';

	/** the column name for the USU_USUARIO field */
	const USU_USUARIO = 'usuario.USU_USUARIO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId', 'UsuNombre', 'UsuApellido', 'UsuCorreo', 'UsuUsuario', 'UsuPassword', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId', 'usuNombre', 'usuApellido', 'usuCorreo', 'usuUsuario', 'usuPassword', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID, self::USU_NOMBRE, self::USU_APELLIDO, self::USU_CORREO, self::USU_USUARIO, self::USU_PASSWORD, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id', 'usu_nombre', 'usu_apellido', 'usu_correo', 'usu_usuario', 'usu_password', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UsuId' => 0, 'UsuNombre' => 1, 'UsuApellido' => 2, 'UsuCorreo' => 3, 'UsuUsuario' => 4, 'UsuPassword' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuId' => 0, 'usuNombre' => 1, 'usuApellido' => 2, 'usuCorreo' => 3, 'usuUsuario' => 4, 'usuPassword' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::USU_ID => 0, self::USU_NOMBRE => 1, self::USU_APELLIDO => 2, self::USU_CORREO => 3, self::USU_USUARIO => 4, self::USU_PASSWORD => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_id' => 0, 'usu_nombre' => 1, 'usu_apellido' => 2, 'usu_correo' => 3, 'usu_usuario' => 4, 'usu_password' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		$criteria->addSelectColumn(UsuarioPeer::USU_ID);
		$criteria->addSelectColumn(UsuarioPeer::USU_NOMBRE);
		$criteria->addSelectColumn(UsuarioPeer::USU_APELLIDO);
		$criteria->addSelectColumn(UsuarioPeer::USU_CORREO);
		$criteria->addSelectColumn(UsuarioPeer::USU_USUARIO);
    ...
    foreach (sfMixer::getCallables('BaseUsuarioPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUsuarioPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(UsuarioPeer::USU_ID) && $criteria->keyContainsValue(UsuarioPeer::USU_ID) ) {
    ...
    foreach (sfMixer::getCallables('BaseUsuarioPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUsuarioPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UsuarioPeer::USU_ID);
			$selectCriteria->add(UsuarioPeer::USU_ID, $criteria->remove(UsuarioPeer::USU_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UsuarioPeer::USU_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(UsuarioPeer::USU_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(UsuarioPeer::DATABASE_NAME);
			$criteria->add(UsuarioPeer::USU_ID, $pks, Criteria::IN);
