...
abstract class BaseCliente extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the cli_apellido field.
	 * @var        string
	 */
	protected $cli_apellido;

	/**
	 * The value for the cli_usuario field.
	 * @var        string
	 */
	protected $cli_usuario;

	/**
	 * The value for the cli_password field.
	 * @var        string
	 */
	protected $cli_password;

	/**
	 * The value for the cli_empresa field.
	 * @var        string
	 */
	protected $cli_empresa;

	/**
	 * The value for the cli_correo field.
	 * @var        string
	 */
	...
	/**
	 * Get the [cli_apellido] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [cli_usuario] column value.
	 * 
	 * @return     string
	 */
	public function getCliUsuario()
	{
		return $this->cli_usuario;
	}

	/**
	 * Get the [cli_password] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [cli_empresa] column value.
	 * 
	 * @return     string
	 */
	public function getCliEmpresa()
	{
		return $this->cli_empresa;
	}

	/**
	 * Get the [cli_correo] column value.
	 * 
	 * @return     string
	 */
	...
	public function setCliId($v)
	{
		...
		if ($this->cli_id !== $v) {
			$this->cli_id = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_ID;
		}
	...
	public function setCliNombre($v)
	{
		...
		if ($this->cli_nombre !== $v) {
			$this->cli_nombre = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_NOMBRE;
		}
	...
	/**
	 * Set the value of [cli_apellido] column.
	 * 
	 * @param      string $v new value
	 * @return     Cliente The current object (for fluent API support)
	 */
	public function setCliApellido($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cli_apellido !== $v) {
			$this->cli_apellido = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_APELLIDO;
		}
	...
	/**
	 * Set the value of [cli_usuario] column.
	 * 
	 * @param      string $v new value
	 * @return     Cliente The current object (for fluent API support)
	 */
	public function setCliUsuario($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cli_usuario !== $v) {
			$this->cli_usuario = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_USUARIO;
		}
	...
	/**
	 * Set the value of [cli_password] column.
	 * 
	 * @param      string $v new value
	 * @return     Cliente The current object (for fluent API support)
	 */
	public function setCliPassword($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cli_password !== $v) {
			$this->cli_password = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_PASSWORD;
		}
	...
	/**
	 * Set the value of [cli_empresa] column.
	 * 
	 * @param      string $v new value
	 * @return     Cliente The current object (for fluent API support)
	 */
	public function setCliEmpresa($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cli_empresa !== $v) {
			$this->cli_empresa = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_EMPRESA;
		}
	...
	/**
	 * Set the value of [cli_correo] column.
	 * 
	 * @param      string $v new value
	 * @return     Cliente The current object (for fluent API support)
	 */
	public function setCliCorreo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->cli_correo !== $v) {
			$this->cli_correo = $v;
			$this->modifiedColumns[] = ClientePeer::CLI_CORREO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cli_apellido = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->cli_usuario = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->cli_password = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->cli_empresa = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->cli_correo = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(ClientePeer::CREATED_AT))
				{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setCliId($pk);  //[IMV] update autoincrement primary key
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getCliApellido();
				break;
			case 3:
				return $this->getCliUsuario();
				break;
			case 4:
				return $this->getCliPassword();
				break;
			case 5:
				return $this->getCliEmpresa();
				break;
			case 6:
				return $this->getCliCorreo();
				break;
			case 7:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getCliApellido(),
			$keys[3] => $this->getCliUsuario(),
			$keys[4] => $this->getCliPassword(),
			$keys[5] => $this->getCliEmpresa(),
			$keys[6] => $this->getCliCorreo(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setCliApellido($value);
				break;
			case 3:
				$this->setCliUsuario($value);
				break;
			case 4:
				$this->setCliPassword($value);
				break;
			case 5:
				$this->setCliEmpresa($value);
				break;
			case 6:
				$this->setCliCorreo($value);
				break;
			case 7:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setCliApellido($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setCliUsuario($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setCliPassword($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCliEmpresa($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCliCorreo($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientePeer::CLI_ID)) $criteria->add(ClientePeer::CLI_ID, $this->cli_id);
		if ($this->isColumnModified(ClientePeer::CLI_NOMBRE)) $criteria->add(ClientePeer::CLI_NOMBRE, $this->cli_nombre);
		if ($this->isColumnModified(ClientePeer::CLI_APELLIDO)) $criteria->add(ClientePeer::CLI_APELLIDO, $this->cli_apellido);
		if ($this->isColumnModified(ClientePeer::CLI_USUARIO)) $criteria->add(ClientePeer::CLI_USUARIO, $this->cli_usuario);
		if ($this->isColumnModified(ClientePeer::CLI_PASSWORD)) $criteria->add(ClientePeer::CLI_PASSWORD, $this->cli_password);
		if ($this->isColumnModified(ClientePeer::CLI_EMPRESA)) $criteria->add(ClientePeer::CLI_EMPRESA, $this->cli_empresa);
		if ($this->isColumnModified(ClientePeer::CLI_CORREO)) $criteria->add(ClientePeer::CLI_CORREO, $this->cli_correo);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ClientePeer::CLI_ID, $this->cli_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCliNombre($this->cli_nombre);

		$copyObj->setCliApellido($this->cli_apellido);

		$copyObj->setCliUsuario($this->cli_usuario);

		$copyObj->setCliPassword($this->cli_password);

		$copyObj->setCliEmpresa($this->cli_empresa);

		$copyObj->setCliCorreo($this->cli_correo);
	 ...
	 * related Campos from storage. If this Cliente is new, it will return
		...
		if ($this->collCampos === null) {
			if ($this->isNew()) {
			   $this->collCampos = array();
				...
				$criteria->add(CampoPeer::CLI_ID, $this->cli_id);
	...
	public function countCampos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collCampos === null) {
			if ($this->isNew()) {
				...
				$count = CampoPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
