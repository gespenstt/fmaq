...
class NoticiaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('NOT_TITULO', 'NotTitulo', 'VARCHAR', false, 255, null);
		$this->addColumn('NOT_URL', 'NotUrl', 'VARCHAR', false, 255, null);
		$this->addColumn('NOT_IMAGEN', 'NotImagen', 'VARCHAR', false, 255, null);
		$this->addColumn('NOT_DESCRIPCION', 'NotDescripcion', 'VARCHAR', false, 255, null);
