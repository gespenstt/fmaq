...
class UsuarioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('USU_ID', 'UsuId', 'INTEGER', true, 11, null);
		$this->addColumn('USU_NOMBRE', 'UsuNombre', 'VARCHAR', false, 100, null);
		$this->addColumn('USU_APELLIDO', 'UsuApellido', 'VARCHAR', false, 100, null);
		$this->addColumn('USU_CORREO', 'UsuCorreo', 'VARCHAR', false, 100, null);
		$this->addColumn('USU_USUARIO', 'UsuUsuario', 'VARCHAR', false, 50, null);
		$this->addColumn('USU_PASSWORD', 'UsuPassword', 'VARCHAR', false, 50, null);
