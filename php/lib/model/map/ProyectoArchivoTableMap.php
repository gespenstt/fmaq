...
class ProyectoArchivoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PAR_NOMBRE', 'ParNombre', 'LONGVARCHAR', false, null, null);
		$this->addColumn('PAR_RUTA', 'ParRuta', 'LONGVARCHAR', false, null, null);
		$this->addColumn('PAR_DESCRIPCION', 'ParDescripcion', 'LONGVARCHAR', false, null, null);
